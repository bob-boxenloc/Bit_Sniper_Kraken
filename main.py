...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 117467  # BULLISH
        vi2_n1 = 120868  # BEARISH
        vi3_n1 = 118738  # BULLISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 117467  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 120868  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 118738  # Valeur de départ fournie par l'utilisateur
