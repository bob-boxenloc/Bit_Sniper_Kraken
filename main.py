...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 119838  # BEARISH
        vi2_n1 = 116918  # BEARISH
        vi3_n1 = 115621  # BEARISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 119838  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 116918  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 115621  # Valeur de départ fournie par l'utilisateur
