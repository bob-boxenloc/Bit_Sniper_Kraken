...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 113952  # BULLISH
        vi2_n1 = 123173  # BEARISH
        vi3_n1 = 120971  # BEARISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 113952  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 123173  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 120971  # Valeur de départ fournie par l'utilisateur
