...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 115012  # BULLISH
        vi2_n1 = 116880  # BULLISH
        vi3_n1 = 117710  # BULLISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 115012  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 116880  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 117710  # Valeur de départ fournie par l'utilisateur
