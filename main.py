...
def update_indicator_history(new_candle):
    ...
    # Timestamps des croisements fournis par l'utilisateur
    vi1_crossing_time = 1753612200000  # 2025-07-26 10:30:00 UTC
    vi2_crossing_time = 1754028900000  # 2025-07-31 06:15:00 UTC
    vi3_crossing_time = 1754076600000  # 2025-07-31 19:30:00 UTC
    ...
    # Calculer les VI avec la vraie logique
    vi_real_logic = calculate_volatility_indexes_real_logic(
        candles, highs, lows, 
        vi1_crossing_time, vi2_crossing_time, vi3_crossing_time
    )
    ...
    if vi_real_logic:
        ...
        print(f"   Croisements trouvés:")
        print(f"     VI1: index {vi_real_logic['vi1_crossing_index']}")
        print(f"     VI2: index {vi_real_logic['vi2_crossing_index']}")
        print(f"     VI3: index {vi_real_logic['vi3_crossing_index']}")
    else:
