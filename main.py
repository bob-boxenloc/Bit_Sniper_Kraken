...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 114745  # BULLISH
        vi2_n1 = 124055  # BEARISH
        vi3_n1 = 122019  # BEARISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 114745  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 124055  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 122019  # Valeur de départ fournie par l'utilisateur
