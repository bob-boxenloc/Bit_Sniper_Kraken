...
def initialize_indicator_history(candles):
    ...
    try:
        ...
        vi1_n1 = 120191  # BEARISH
        vi2_n1 = 117617  # BEARISH
        vi3_n1 = 116497  # BEARISH
...
def update_indicator_history(new_candle):
    ...
    vi1_n1 = 120191  # Valeur de départ fournie par l'utilisateur
    vi2_n1 = 117617  # Valeur de départ fournie par l'utilisateur
    vi3_n1 = 116497  # Valeur de départ fournie par l'utilisateur
